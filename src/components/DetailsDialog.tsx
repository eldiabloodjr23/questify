      ...
      <DialogContent className="w-[70vw] max-w-[100vw] md:w-[50vw]">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            Máte plné zuby nudných a opakujících se kvízů? Sbohem rutině a vítáme mimořádnost s Quuestify! Naše platforma mění zážitek z kvízů a trivií tím, že využívá obrovský potenciál umělé inteligence.
            </p>
            <hr />
